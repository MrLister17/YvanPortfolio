    ...
    <>
      ...
      <section className="section-shell section-block split-feature numbered-section">
        <Reveal variant="fade" className="practicum-card">
          ...
          <dl><div><dt>Period</dt><dd>June 8 — August 15</dd></div><div><dt>Setup</dt><dd>{portfolioConfig.practicum.setup}</dd></div><div><dt>Required hours</dt><dd>{portfolioConfig.practicum.totalHours}</dd></div></dl>
        </Reveal>
      </section>
